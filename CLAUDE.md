...
- **Logo navbar:** texto tricolor com fundo branco — `.logo-aluno` (verde `#00a855`), `.logo-maker` (vermelho `#e53935`), `.logo-digital` (azul `#0066ff`). Fonte Orbitron mantida. Sem imagem.
